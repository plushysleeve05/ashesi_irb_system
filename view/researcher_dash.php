    ...
    <header>
        <div class="Logo_section">
            <a href="researcher_dash.php">
                <!-- <img src="../images/Ashesi_University_Logo_Small_2cm__1_-removebg-preview.png" alt="Ashesi Logo" height="50"> -->
                <div class="IRB_title">
                    <h1>INSTITUTIONAL</h1>
                    <h1>REVIEW</h1>
                    <h1>BOARD</h1>
